...
! function(a, b, c) {
    ...
    d.prototype = {
        ...
        render: function() {
            return this._clear(), this._container.addClass(this.containerClass).css("position", "relative").append(this._createHeader()).append(this._createBody()), this._pagerContainer = this._createPagerContainer(), this._loadIndicator = this._createLoadIndicator(), this.refresh(), this.autoload ? this.loadData() : b.Deferred().resolve().promise()
        },
        ...
        _setSortingParams: function(a, b) {
            a = this._normalizeSortingField(a), b = b || (this._sortField === a ? this._reversedSortOrder(this._sortOrder) : i), this._sortField = a, this._sortOrder = b
        },
        ...
        _refreshPager: function() {
            ...
            a.empty(), this.paging && this._pagesCount() > 1 ? a.show().append(this._createPager()) : a.hide()
        },
        ...
        _createPages: function() {
            ...
            for (var f = 0, a = d; c > f && b >= a; f++, a++) e.push(a === this.pageIndex ? this._createPagerCurrentPage() : this._createPagerPage(a));
            return b > d + c - 1 && e.push(this._createPagerPageNavButton(this.pageNavigatorNextText, this.showNextPages)), e
        },
        _createPagerNavButton: function(a, b) {
            return this._createPagerButton(a, this.pagerNavButtonClass, function() {
                this.openPage(b)
            })
        },
        ...
        _controllerCall: function(a, c, d) {
            this._showLoading();
            var e = this._controller;
            if (!e || !e[a]) throw new Error("controller has no method '" + a + "'");
            return b.when(e[a](c)).done(b.proxy(d, this)).fail(b.proxy(this._errorHandler, this)).always(b.proxy(this._hideLoading, this))
        },
        ...
        _showLoading: function() {
            clearTimeout(this._loadingTimer), this._loadingTimer = setTimeout(b.proxy(function() {
        ...
        loadData: function(a) {
           ...
           return a= a || (this.filtering ? this.getFilter() : {}), b.extend(a, this._loadStrategy.loadParams(), this._sortingParams()), this._callEventHandler(this.onDataLoading, {
                filter: a


            }), this._controllerCall("loadData", a, function(a) {
                this._loadStrategy.finishLoad(a), this._callEventHandler(this.onDataLoaded, {
                    data: a
                })
            })
        },
        ...
        insertItem: function(a) {
            ...
            return this._callEventHandler(this.onItemInserting, {
                item: b
            }), this._controllerCall("insertItem", b, function(a) {
                a = a || b, this._loadStrategy.finishInsert(a), this._callEventHandler(this.onItemInserted, {
                    item: a
                })
            })
        },
        ...
        _updateRow: function(a, c) {
            var d = a.data(g),
                e = this._itemIndex(d),
                f = b.extend({}, d);
            return b.extend(d, c), this._callEventHandler(this.onItemUpdating, {
                row: a,
                item: d,
                itemIndex: e,
                previousItem: f
            }), this._controllerCall("updateItem", d, function(b) {
                b = b || d, this._finishUpdate(a, b, e), this._callEventHandler(this.onItemUpdated, {
                    row: a,
                    item: b,
                    itemIndex: e,
                    previousItem: f
        ...
        _finishUpdate: function(a, b, c) {
            this.cancelEdit(), this.data[c] = b, a.replaceWith(this._createRow(b, c))
        },
        ...
        _deleteRow: function(a) {
            var b = a.data(g),
                c = this._itemIndex(b);
            return this._callEventHandler(this.onItemDeleting, {
                row: a,
                item: b,
                itemIndex: c
            }), this._controllerCall("deleteItem", b, function() {
