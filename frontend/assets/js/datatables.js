...
(function(l, q) {
    var d = function(b, c) {
        b.extend(!0, c.defaults, {
            dom: "<'uk-grid uk-grid-collapse'<'uk-width-1-10 btn1'><'uk-width-1-10 btn2'><'uk-width-5-10 upl'><'uk-width-1-10'l><'uk-width-2-10'f>><'uk-grid'<'uk-width-1-1'tr>><'uk-grid'<'uk-width-1-1'p>>",
            renderer: "bootstrap"
        });
        b.extend(c.ext.classes, {
            sWrapper: "dataTables_wrapper form-inline dt-bootstrap",
            sFilterInput: "md-input md-input-small",
            sLengthSelect: "md-input md-input-small",
        ...
        c.ext.renderer.pageButton.bootstrap = function(g, d, r, s, i, m) {
            ...
            p(b(d).empty().html('<ul class="uk-pagination"/>').children("ul"), s);
            h && b(d).find("[data-dt-idx=" + h + "]").focus()
        };
        c.TableTools && (b.extend(!0, c.TableTools.classes, {
            container: "DTTT btn-group",
            buttons: {
                normal: "md-btn md-btn-default",
                disabled: "disabled"
            },
            collection: {
