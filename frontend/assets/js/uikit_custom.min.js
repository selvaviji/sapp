! function(t) {
    ...
    if (n.version = "2.21.0", n.noConflict = function() {
        ...
        var e = 0;
        t.requestAnimationFrame = t.requestAnimationFrame || t.webkitRequestAnimationFrame || function(i, n) {
    ...
    if (!t.fn.swipeLeft) {
        ...
        t(function() {
            ...
            "MSGesture" in window && (c = new MSGesture, c.target = document.body), t(document).on("MSGestureEnd gestureend", function(t) {
                ...
                ("MSPointerDown" != e.type || s(e.originalEvent)) && (m = "MSPointerDown" == e.type || "pointerdown" == e.type ? e : e.originalEvent.touches[0], p = Date.now(), f = p - (d.last || p), d.el = t("tagName" in m.target ? m.target : m.target.parentNode), a && clearTimeout(a), d.x1 = m.pageX, d.y1 = m.pageY, f > 0 && 250 >= f && (d.isDoubleTap = !0), d.last = p, u = setTimeout(i, h), !c || "MSPointerDown" != e.type && "pointerdown" != e.type && "touchstart" != e.type || c.addPointer(e.originalEvent.pointerId))
                ...
                s = function() {
                    ...
                    n.each(function(n) {
                        var r = t.$(this),
                            ...
                            c = r.data("ukScrollspyCls") || o[a].trim();
                        !u || l || r.data("scrollspy-idle") || (e || (r.addClass(i.options.initcls), i.offset = r.offset(), e = !0, r.trigger("init.uk.scrollspy")), r.data("scrollspy-idle", setTimeout(function() {
                            r.addClass("uk-scrollspy-inview").toggleClass(c).width(), r.trigger("inview.uk.scrollspy"), r.data("scrollspy-idle", !1), r.data("inviewstate", !0)
                        }, i.options.delay * s)), s++), !u && l && i.options.repeat && (r.data("scrollspy-idle") && clearTimeout(r.data("scrollspy-idle")), r.removeClass("uk-scrollspy-inview").toggleClass(c), r.data("inviewstate", !1), r.trigger("outview.uk.scrollspy")), a = o[a + 1] ? a + 1 : 0
                    })
                };
                        ...
                        var s, c = e.scrollTop(),
                            d = function() {
                                for (var t = 0; t < i.length; t++)
                                    if (i[t].offset().top >= c) return i[t]
                            }();
                        if (!d) return;
                        u.options.closest ? (o.closest(l).removeClass(r), s = o.filter("a[href='#" + d.attr("id") + "']").closest(l).addClass(r)) : s = o.removeClass(r).filter("a[href='#" + d.attr("id") + "']").addClass(r), u.element.trigger("inview.uk.scrollspynav", [d, s])
                    }
                };
            this.options.smoothscroll && t.smoothScroll && o.each(function() {
                t.smoothScroll(this, u.options.smoothscroll)
            }), c(), this.element.data("scrollspynav", this), this.check = c, s.push(this)
        }
    })
}(UIkit),
function(t) {
    ...
    t.component("tab", {
        ...
        check: function() {
            ...
            if (this.responsivetab.lst.empty(), e.each(function() {
                ...
                for (var r = 0; r < e.length; r++) i = t.$(e.eq(r)), n = i.find("a"), "none" == i.css("float") || i.attr("uk-dropdown") || (i.hasClass("uk-disabled") || (o = i[0].outerHTML.replace("<a ", '<a data-index="' + r + '" '), this.responsivetab.lst.append(o)), i.addClass("uk-hidden"));
...
function(t) {
    ...
    return t.component("autocomplete", {
        ...
        pick: function(e, i) {
            ...
            } else s = e; if (s && s.length && (this.selected = s, o.removeClass(this.options.hoverClass), this.selected.addClass(this.options.hoverClass), i)) {
...
function(t) {
    ...
    return t.component("datepicker", {
        defaults: {
            ...
            template: function(e, i) {
                ...
                if (i.maxDate !== !1 && (n = isNaN(i.maxDate) ? moment(i.maxDate, i.format) : moment().add(i.maxDate, "days")), i.minDate !== !1 && (o = isNaN(i.minDate) ? moment(i.minDate, i.format) : moment().add(i.minDate - 1, "days")), a += '<div class="uk-datepicker-nav uk-clearfix">', a += '<a href="" class="uk-datepicker-previous"></a>', a += '<a href="" class="uk-datepicker-next"></a>', t.formSelect) {
                    var r, l, u, c, d = (new Date).getFullYear(),
                        h = [];
                    ...
                    for (r = '<span class="uk-form-select">' + i.i18n.months[e.month] + '<select class="update-picker-month">' + h.join("") + "</select></span>", h = [], u = o ? o.year() : d - 50, c = n ? n.year() : d + 20, s = u; c >= s; s++) h.push(s == e.year ? '<option value="' + s + '" selected>' + s + "</option>" : '<option value="' + s + '">' + s + "</option>");
                ...
                for (a += "</thead>", a += "<tbody>", s = 0; s < e.days.length; s++)
                    if (e.days[s] && e.days[s].length) {
                        a += "<tr>";
                        for (var p = 0; p < e.days[s].length; p++)
                            if (e.days[s][p]) {
                                var f = e.days[s][p],
                                    m = [];
        ...
        init: function() {
            if (t.support.touch && !this.options.mobile && this.element.attr("type", "date"), !t.support.touch || "date" != this.element.attr("type") || this.options.mobile) {
                var n = this;
        ...
        pick: function(n) {
            var o = this.element.offset(),
                s = o.left - parseInt($page_content.css("margin-left")),
                a = o.top + $page_content.scrollTop() - $page_content.position().top,
                r = {
                    left: s,
                    right: ""
                };
        ...
        getRows: function(t, e) {
            ...
            l += 7 - u;
            for (var c, d, h, p, f, m = 0, g = 0; l > m; m++) c = new Date(t, e, 1 + (m - s)), d = i.mindate && c < i.mindate || i.maxdate && c > i.maxdate, f = !(s > m || m >= o + s), c = moment(c), h = this.initdate == c.format("YYYY-MM-DD"), p = n == c.format("YYYY-MM-DD"), r.push({
                selected: h,
                today: p,
                disabled: d,
                day: c,
...
function(t) {
    ...
    t.component("grid", {
        ...
        updateLayout: function(i) {
            ...
            var n, o, s, a, r, l, u, c, d = i,
                h = this.element.width() + 2 * this.gutterh + 2,
                p = 0,
                f = 0,
                m = [];
            this.trigger("beforeupdate.uk.grid", [d]), d.each(function(i) {
                for (c = e(this), n = t.$(this), o = c.outerWidth, s = c.outerHeight, p = 0, f = 0, r = 0, u = m.length; u > r; r++) a = m[r], p <= a.aX && (p = a.aX), p + o > h && (p = 0), f <= a.aY && (f = a.aY);
                m.push({
                    ele: n,
                    top: f,
                    left: p,
            ...
            }, 2 * this.options.duration * (this.options.animation ? 1 : 0)), this.trigger("afterupdate.uk.grid", [d])
        },
        filter: function(e) {
    ...
    var i = function() {
        function t(t) {
            if (t) {
                if ("string" == typeof c[t]) return t;
                t = t.charAt(0).toUpperCase() + t.slice(1);
                for (var e, i = 0, n = u.length; n > i; i++)
                    if (e = u[i] + t, "string" == typeof c[e]) return e
            }
        }
        ...
        function s(t) {
            if (o(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                for (var u = s.isBorderBox = !(!r || !i[r] || "border-box" !== i[r]), c = 0, d = h.length; d > c; c++) {
                    var p = h[c],
                        f = i[p],
                        m = parseFloat(f);
                    s[p] = isNaN(m) ? 0 : m
        ...
        var a, r, l, u = "Webkit Moz ms Ms O".split(" "),
            ...
            d = "undefined" == typeof console ? i : function(t) {
                console.error(t)
...
function(t) {
    ...
    return t.component("nestable", {
        ...
        init: function() {
            ...
            i ? (this.element[0].addEventListener(a, o, !1), window.addEventListener(r, c, !1), window.addEventListener(l, d, !1), window.addEventListener(u, d, !1)) : (this.on(a, o), s.on(r, c), s.on(l, d))
        },
        serialize: function() {
            var e, i = 0,
                n = this,
        ...
        dragStart: function(i) {
            ...
            var l, u, c = this.dragEl.find(this.options._listItemClass);
            for (l = 0; l < c.length; l++) u = t.$(c[l]).parents(this.options._listClass + "," + this.options._listBaseClass).length, u > this.dragDepth && (this.dragDepth = u);
        ...
        dragMove: function(e) {
            var i, n, s, a, r, l = this.options,
                u = this.mouse,
                c = this.dragRootEl ? this.dragRootEl.data("nestable").options.maxDepth : l.maxDepth;
            this.dragEl.css({
            ...
            var d = Math.abs(u.distX) > Math.abs(u.distY) ? 1 : 0;
            if (!u.moving) return u.dirAx = d, void(u.moving = !0);
            u.dirAx !== d ? (u.distAxX = 0, u.distAxY = 0) : (u.distAxX += Math.abs(u.distX), 0 !== u.dirX && u.dirX !== u.lastDirX && (u.distAxX = 0), u.distAxY += Math.abs(u.distY), 0 !== u.dirY && u.dirY !== u.lastDirY && (u.distAxY = 0)), u.dirAx = d, u.dirAx && u.distAxX >= l.threshold && (u.distAxX = 0, s = this.placeEl.prev("li"), u.distX > 0 && s.length && !s.hasClass(l.collapsedClass) && (i = s.find(l._listClass).last(), r = this.placeEl.parents(l._listClass + "," + l._listBaseClass).length, r + this.dragDepth <= c && (i.length ? (i = s.children(l._listClass).last(), i.append(this.placeEl)) : (i = t.$("<ul/>").addClass(l.listClass), i.append(this.placeEl), s.append(i), this.setParent(s)))), u.distX < 0 && (a = this.placeEl.next("li"), a.length || (n = this.placeEl.parent(), this.placeEl.closest(l._listItemClass).after(this.placeEl), n.children().length || this.unsetParent(n.parent()))));
            var h = !1,
            ...
            if (this.pointEl = t.$(document.elementFromPoint(p, f)), l.handleClass && this.pointEl.hasClass(l.handleClass)) this.pointEl = this.pointEl.closest(l._listItemClass);
                ...
                if (!u.dirAx || k || h) {
                    ...
                    if (o.push(g), r = this.dragDepth - 1 + this.pointEl.parents(l._listClass + "," + l._listBaseClass).length, r > c) return;
...
function(t) {
    ...
    var e = {}, i = {}, n = function(e) {
            ...
            var n;
            if (t)
                for (n in i) t === i[n].group && i[n].close(e);
            else
                for (n in i) i[n].close(e)
        }, s = function(n) {
...
function(t) {
    ...
    var s, a, r, l, u, c, d, h, p, f = "ontouchstart" in window || window.DocumentTouch && document instanceof DocumentTouch;
    return t.component("sortable", {
        ...
        boot: function() {
            t.ready(function(e) {
                ...
                if (d) {
                    ...
                    (Math.abs(i.pageX - d.pos.x) > d.threshold || Math.abs(i.pageY - d.pos.y) > d.threshold) && d.apply(i)
                }
                if (s) {
                ...
                if (d = c = !1, !a || !s) return void(a = s = null);
                var i = e(t.target),
                    n = s.$sortable,
                    o = {
                        type: t.type
        ...
        init: function() {
            function e() {
                f ? c.addEventListener("touchmove", v, !1) : (c.addEventListener("mouseover", m, !1), c.addEventListener("mouseout", g, !1))
            }

            function i() {
                f ? c.removeEventListener("touchmove", v, !1) : (c.removeEventListener("mouseover", m, !1), c.removeEventListener("mouseout", g, !1))
            }
            ...
            function l(e) {
                return function(i) {
                    var o, s, a;
                    i && (o = f && i.touches && i.touches[0] || {}, s = o.target || i.target, f && document.elementFromPoint && (s = document.elementFromPoint(i.pageX - document.body.scrollLeft, i.pageY - document.body.scrollTop))), t.$(s).hasClass(u.options.childClass) ? e.apply(s, [i]) : s !== c && (a = n(c, s), a && e.apply(a, [i]))
                }
            }
            var u = this,
                c = this.element[0];
            ...
            this.addDragHandlers = e, this.removeDragHandlers = i, window.addEventListener(f ? "touchmove" : "mousemove", s, !1), c.addEventListener(f ? "touchstart" : "mousedown", d, !1)
        },
                    ...
                    d = {
                        ...
                        apply: function(e) {
                            s = t.$('<div class="' + [n.options.draggingClass, n.options.dragCustomClass].join(" ") + '"></div>').css({
                                ...
                                origin: n.element,
                                index: c.index()
                            }).append(c.html()).appendTo("body"), s.$current = c, s.$sortable = n, c.data("sortable-group", n.options.group), n.addDragHandlers(), n.options.start(this, a), n.trigger("start.uk.sortable", [n, a]), p = !0, d = !1
                        }
                    }
                }
            }
        ...
        dragMove: function(e, i) {
            var n, o = t.$(document.elementFromPoint(e.pageX - document.body.scrollLeft, e.pageY - (window.pageYOffset || document.documentElement.scrollTop))),
                ...
                l = t.$(a),
                u = l.parent(),
                c = l.data("sortable-group");
            s[0] !== u[0] && void 0 !== c && r === c && (s.data("sortable").addDragHandlers(), h.push(s), s.children().addClass(this.options.childClass), s.children().length > 0 ? (n = o.closest("." + this.options.childClass), n.before(l)) : o.append(l), 0 === u.children().length && u.html(""), UIkit.$doc.trigger("mouseover"))
        },
...
function(t) {
    ...
    function e() {
        ...
        if (e.length && !(i.scrollTop() < 0))
            for (var s, a, r, l, u = i.scrollTop(), c = n.height(), d = i.height(), h = c - d, p = u > h ? h - u : 0, f = 0; f < e.length; f++)
                if (l = e[f], l.element.is(":visible") && !l.animate) {
                    if (l.check()) {
                        if (l.options.top < 0 ? s = 0 : (r = l.element.outerHeight(), s = c - r - l.options.top - l.options.bottom - u - p, s = 0 > s ? s + l.options.top : l.options.top), l.boundary && l.boundary.length) {
                            var m = l.boundary.offset().top;
                            a = l.boundtoparent ? c - (m + l.boundary.outerHeight()) + parseInt(l.boundary.css("padding-bottom")) : c - m - parseInt(l.boundary.css("margin-top")), s = u + r > c - a - (l.options.top < 0 ? 0 : l.options.top) ? c - a - (u + r) : s
                        }
                        if (l.currentTop != s) {
                            if (l.element.css({
                                position: "fixed",
    ...
    return t.component("tooltip", {
        ...
        show: function() {
            if (this.tip = "function" == typeof this.options.src ? this.options.src(this.element) : this.options.src, i && clearTimeout(i), n && clearTimeout(n), this.tip.length) {
                ...
                "left" != c[0] && "right" != c[0] || "right" != t.langdirection || (c[0] = "left" == c[0] ? "right" : "left");
                var m = {
                    bottom: {
                ...
                t.$.extend(d, m[c[0]]), 2 == c.length && (d.left = "left" == c[1] ? s.left : s.left + s.width - a);
                var g = this.checkBoundary(d.left, d.top, a, r);
                if (g) {
                    switch (g) {
                        case "x":
                            u = 2 == c.length ? c[0] + "-" + (d.left < 0 ? "left" : "right") : d.left < 0 ? "right" : "left";
                            break;
                        case "y":
                            u = 2 == c.length ? (d.top < 0 ? "bottom" : "top") + "-" + c[1] : d.top < 0 ? "bottom" : "top";
                            break;
                        case "xy":
                            u = 2 == c.length ? (d.top < 0 ? "bottom" : "top") + "-" + (d.left < 0 ? "left" : "right") : d.left < 0 ? "right" : "left"
                    }
                    c = u.split("-"), t.$.extend(d, m[c[0]]), 2 == c.length && (d.left = "left" == c[1] ? s.left : s.left + s.width - a)
                }
                d.left -= t.$body.position().left, i = setTimeout(function() {
                    e.css(d).attr("class", ["uk-tooltip", "uk-tooltip-" + u, o.options.cls].join(" ")), o.options.animation ? e.css({
                        opacity: 0,
                        display: "block"
        ...
        hide: function() {
            if (!this.element.is("input") || this.element[0] !== document.activeElement)
                if (i && clearTimeout(i), n && clearTimeout(n), e.stop(), this.options.animation) {
                    var t = this;
        ...
        if (o = t.$.extend({}, e.defaults, o), n.length) {
            if ("*.*" !== o.allow)
                for (var a, r = 0; a = n[r]; r++)
                    if (!i(o.allow, a.name)) return void("string" == typeof o.notallowed ? alert(o.notallowed) : o.notallowed(a, o));
            var l = o.complete;
            if (o.single) {
                var u = n.length,
                    c = 0,
                ...
                o.beforeAll(n), o.complete = function(t, e) {
                    c += 1, l(t, e), o.filelimit && c >= o.filelimit && (d = !1), d && u > c ? s([n[c]], o) : o.allcomplete(t, e)
                }, s([n[0]], o)
