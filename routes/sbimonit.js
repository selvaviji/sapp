...
module.exports = function(passport) {
  ...
  router.get('/', isAuthenticated, function(req, res){
      ...
      res.render('sbimonit/index',{title:"AlarmLists", sess_name: req.session.uname, sess_id: req.session.rid, minRange: minRange, maxRange: maxRange, stepRange: stepRange});
  });
         ...
         // console.log("STEP-2 :"+nextPageValue+" Status:"+statusValue);
          ...
          if(typeof req.body.pinid != undefined && req.body.pinid != ''){
            ...
            sql = "SELECT a.pin_id, a.customer_id, a.alarmpin_name, a.alarmpin_priority, b.*,c.site_name,c.site_address"+ 
                      ...
                      " AND a.alarmpin_status='0' AND b.ackby='0' AND a.customer_id='7'"+query+" ORDER BY b.Opentime DESC "+"limit "+limitStartVal+","+numberofrecords+"";           
