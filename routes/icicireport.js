...
module.exports = function(passport,dbconnection) {
    ...
    router.get('/', isAuthenticated,function(req, res){
        ...
        res.render('icicireport/index',{title:"HK Report", sess_name: req.session.uname, sess_id: req.session.rid});
    ...
    router.post('/getSiteInfo',function(req,res){
        ...
        sql = "SELECT a.idicicireport,a.siteid,concat('/snapshots/',a.imgpath) imgpath,a.status,DATE_FORMAT(a.createdAt,'%d-%m-%Y %H:%i:%s') createdAt, "+
              "b.site_name,b.site_address "+
              "FROM icicireport a,tbl_site b "+
              "WHERE a.siteid=b.site_code and a.customer='10' and a.status='ok' and a.createdAt >='"+querydata.fromdate+"' AND a.createdAt <='"+querydata.todate+"'";      
